...
public class Task1 {
    ...
    public static String findFunctionByName(String name){
        File file = new File("C:\\Users\\levan.WIN10_SL\\IdeaProjects\\oop201813112018\\nhan4.txt");
        int dem = 0;
        try {
    ...
    public static void main(String [] args) {
        ...
        ob = Task1.getAllFunctions(new File("C:\\Users\\levan.WIN10_SL\\IdeaProjects\\oop201813112018\\src\\week9\\Utils.java"));
        for (String s : ob) {
